function solve() {
   ...
   let topRestaurnatsString = `Name: ${bestRestaurant.restaurantName} Average Salary: ${averageSalary} Best Salary: ${bestSalary}`
   ...
   bestRestaurantElement.textContent = topRestaurnatsString;
